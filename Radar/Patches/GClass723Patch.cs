...
namespace Radar.Patches
{
    internal class GClass723PatchAdd : ModulePatch
    {
        ...
        {
            return typeof(DictionaryListHydra<int, LootItem>).GetMethod("Add", BindingFlags.Instance | BindingFlags.Public);
        }
    ...
    internal class GClass723PatchRemove : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return typeof(DictionaryListHydra<int, LootItem>).GetMethod("Remove", BindingFlags.Instance | BindingFlags.Public);
        }
