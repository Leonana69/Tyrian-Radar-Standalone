        ...
        private static Dictionary<string, Dictionary<string, string>> translations = new Dictionary<string, Dictionary<string, string>>()
{
            {"EN", new Dictionary<string, string>{
                ...
                {"radar_pulse_enable","Radar Pulse"},
                {"radar_pulse_enable_info","Adds the radar scan animation"},
                {"radar_corpse_enable","Corpse Detection"},
                {"radar_corpse_type_enable","Show corpse type"},
                {"radar_corpse_shortcut","Short cut for enable/disable corpse dection"},
                {"radar_loot_enable","Loot Detection Enabled"},
                {"radar_wishlist_enable","Wishlisted Detection Enabled (ONLY FROM OTHER CATEGORY)"},
                {"radar_loot_shortcut","Short cut for enable/disable valuable loot dection"},
                ...
                {"radar_minefield_enable", "Minefield"},
                {"radar_minefield_enable_info", "Show minefield on radar map"},
                ...
                {"radar_wishlist_loot_blip_color","Wishlist Loot Color"},
            ...
            {"ZH", new Dictionary<string, string>{
                ...
                {"radar_corpse_type_enable", "显示尸体类型"},
                ...
                {"radar_minefield_enable", "雷区"},
                {"radar_minefield_enable_info", "在雷达地图上显示雷区"},
                ...
                {"radar_wishlist_loot_blip_color", "愿望单物品颜色"},
            ...
            {"RU", new Dictionary<string, string>{
                ...
                {"radar_pulse_enable", "Визуальный радарный импульс"},
                {"radar_pulse_enable_info","Добавляет эффект радарного сканирования"},
                {"radar_corpse_enable", "Обнаружение трупов"},
                {"radar_corpse_type_enable","Показывать тип трупа"},
                {"radar_corpse_shortcut","Кнопка для включения/выключения обнаружения трупов"},
                {"radar_loot_enable", "Обнаружение лута"},
                {"radar_wishlist_enable","Обнаружение лута из избранного (!Только из категории Прочее, со звёздочкой)"},
                {"radar_loot_shortcut","Кнопка для включения/отключения обнаружения лута"},
                ...
                {"radar_minefield_enable", "Минные поля"},
                {"radar_minefield_enable_info", "Показать минные поля на радаре"},
                ...
                {"radar_distance_scale_info","Изменяет масштаб расстояния в зависимости от расстояния до игрока"},
                {"radar_y_height_threshold", "Порог высоты меток HUD"},
                {"radar_y_height_threshold_info","Добавляет стрелки выше или ниже в зависимости от разности по высоте метки и игрока"},
                {"radar_x_position", "Смещение позиции HUD по оси X"},
                {"radar_x_position_info", "Позиция X на экране для радара"},
                {"radar_y_position", "Смещение позиции HUD по оси Y"},
                {"radar_y_position_info", "Позиция Y на экране для радара"},
                {"radar_outer_range", "Максимальный радиус радара"},
                {"radar_outer_range_info", "Максимальное расстояние до объектов для отображения на радаре"},
                {"radar_inner_range", "Минимальный радиус радара"},
                {"radar_inner_range_info", "Минимальное расстояние до объектов для отображения на радаре"},
                {"radar_scan_interval", "Частота сканирования радара"},
                {"radar_scan_interval_info","Интервал между двумя сканированиями"},
                {"radar_loot_threshold", "Минимальная стоимость лута"},
                {"radar_loot_threshold_info", "Товар стоимостью выше этой будет отображаться на радаре"},
                {"radar_loot_per_slot", "Стоимость лута оценивается по стоимости на слот"},
                {"radar_boss_blip_color", "Цвет боссов"},
                {"radar_scav_blip_color", "Цвет диких"},
                {"radar_usec_blip_color", "Цвет USEC"},
                {"radar_bear_blip_color", "Цвет BEAR"},
                {"radar_corpse_blip_color", "Цвет трупов"},
                {"radar_loot_blip_color", "Цвет лута"},
                {"radar_wishlist_loot_blip_color", "Цвет лута из избранного"},
                {"radar_background_color", "Цвет фона"},
                {"radar_minefield_color","Цвет минных полей"},
            }},
            {"KO", new Dictionary<string, string>{
                ...
                {"radar_corpse_type_enable","시체 유형 표시"},
                ...
                {"radar_minefield_enable", "지뢰밭"},
                {"radar_minefield_enable_info", "레이더에 지뢰밭 표시"},
                ...
                {"radar_wishlist_loot_blip_color","위시리스트 전리품 색상"},
