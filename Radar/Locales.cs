        ...
        private static Dictionary<string, Dictionary<string, string>> translations = new Dictionary<string, Dictionary<string, string>>()
{
            ...
            {"RU", new Dictionary<string, string>{
                ...
                {"radar_wishlist_enable","Обнаружение лута из избранного (ТОЛЬКО КАТЕГОРИЯ ПРОЧЕЕ)"},
                ...
                {"radar_minefield_enable", "Минное поле"},
                {"radar_minefield_enable_info", "Показать минное поле на радаре"},
